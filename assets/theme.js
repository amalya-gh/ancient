...
theme.MobileNav = (function() {
  ...
  function init() {
    ...
    if (cache.mobileNavToggle) {
      cache.mobileNavToggle.addEventListener('click', openMobileNav);
    }
...
if(document.getElementById('addQty') || document.getElementById('minusQty')){
  let QInput=document.getElementById('Quantity-product-template')
